...
<li><a href="enquiry.jsp">ENQUIRY</a></li>
                ...
                <div id="container">
                    <div id="left"></div>
                    <div id="main">
                        <h1 style="text-align: center; color:blue"><marquee bgcolor=green behavior="alternate">Student Login</marquee></h1>
                          <fieldset style="background-image:url(images/book5.jpg)">  <table  align="center">
                                <tr><td>Enter user id</td>
                                    <td><input type="text" name="userid" required="true"></td></tr><td>&nbsp;</td><td>&nbsp;</td>
                                <tr><td>Enter password</td>
                                    <td><input type="password" name="password" required="true"></td></tr><td>&nbsp;</td><td>&nbsp;</td>
                                 </tr><td>&nbsp;</td>
